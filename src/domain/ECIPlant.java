...
public class ECIPlant extends Plant{
    ...
    public ECIPlant(JButton button, JLayeredPane layeredPane, ArrayList<Collectable> suns,boolean modeMachine) {
        super.hp = 150;
        super.button = button;
    ...
    private void createSun(){
        ACTION_USES--;
        suns.add(new Sun(50,2,layeredPane,button,modeMachine));
    }
}
